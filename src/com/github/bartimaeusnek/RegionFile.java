 ...
 */
 ...
 /*
 *
 * Slightly modified by bartimaeusnek on 07. June 2018
 *
 */
...
public class RegionFile {
	...
	public final int chunkTimestamps[];
	...
	public void debugln(String in) {
		debug(in + "\n");
	}

	public void debug(String mode, int x, int z, String in) {
		debug("REGION " + mode + " " + fileName.getName() + "[" + x + "," + z + "] = " + in);
	}

	public void debug(String mode, int x, int z, int count, String in) {
		debug("REGION " + mode + " " + fileName.getName() + "[" + x + "," + z + "] " + count + "B = " + in);
	}

	public void debugln(String mode, int x, int z, String in) {
		debug(mode, x, z, in + "\n");
	}
	...
	public void write(int sectorNumber, byte[] data, int length) throws IOException {
	...
	public void setOffset(int x, int z, int offset) throws IOException {
		offsets[x + z * 32] = offset;
		file.seek((x + z * 32) * 4);
		file.writeInt(offset);
	}

	public void setTimestamp(int x, int z, int value) throws IOException {
